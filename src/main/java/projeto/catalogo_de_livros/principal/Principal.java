package projeto.catalogo_de_livros.principal;

import projeto.catalogo_de_livros.modelos.Autor;
import projeto.catalogo_de_livros.modelos.Livro;
import projeto.catalogo_de_livros.modelos.LivroDTO;
import projeto.catalogo_de_livros.repository.LivroRepository;
import projeto.catalogo_de_livros.service.ConsultaAPI;
import projeto.catalogo_de_livros.service.ConverteDados;
...
public class Principal {
    ...
    private void buscarLivro() {
        ...
        String enderecoBusca = ENDERECO.concat(nomeLivro.replace(" ", "%20").toLowerCase().trim());
